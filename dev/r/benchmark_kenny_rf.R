## benchmark_kenny_rf.R
##
## Benchmark 1: Controls-only RF using Kenny's building density covariate
## plus terrain. No SSDD metrics. This is the "no-SSDD" reference that the
## SSDD baselines must improve upon.
##
## Features: build_dens, elevation, slope, aspect
##
...
out_path <- "dev/r/benchmark_kenny_rf_results.csv"
write_csv(results, out_path)
message(sprintf("Wrote %s", out_path))

pred_path <- "dev/r/benchmark_kenny_rf_predictions.csv"
